# Six-Side Sink Dark-Manifest Note
...
v0.13 compares two intake geometries in the eight-sector knot/shadow model.
...
The dark-manifest sector is mass-active and gravity-active, but light/electromagnetic activation is suppressed.
...
```text
1 sector  = visible tip
1 sector  = opposite axis
6 sectors = side-intake belt
```
