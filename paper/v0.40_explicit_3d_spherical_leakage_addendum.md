# Addendum v0.40: Explicit 3D Spherical Leakage Collision Test
...
## 5. Shape-derived channel fractions
...
```text
The explicit 3D cubic retest forms a central sink and a real 3D vibration shell. The center remains stable, shell formation is direct rather than reconstructed, and the shell is mostly spherical with subdominant anisotropy. However, the 3D geometry shifts the channel hierarchy toward excessive compact mass retention: bb-like is too high and WZ-like is too low against the rough Higgs hierarchy targets.
```
...
Before v0.41, the geometric issue to inspect is:
